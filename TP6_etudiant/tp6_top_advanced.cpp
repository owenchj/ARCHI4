...
int _main(int argc, char *argv[])
{
    ...
    std::cout << "    dcache_wbuf_nwords  = " << wbuf_nwords << std::endl;
    std::cout << "    dcache_wbuf_nlines  = " << wbuf_nlines << std::endl;
    ...
    proc = new VciXcacheWrapperAdvanced<vci_param,Mips32ElIss>("proc",
                                                               0,
                                                               maptab,
                                                               IntTab(SRCID_PROC),
                                                               icache_ways,
