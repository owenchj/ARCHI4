...
int _main(int argc, char *argv[])
{
    ...
    char    sys_path[256]       = "soft_prime/sys.bin";   // pathname for system code
    char    app_path[256]       = "soft_prime/app.bin";   // pathname for application code
